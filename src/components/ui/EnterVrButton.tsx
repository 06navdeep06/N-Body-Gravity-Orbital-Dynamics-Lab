...
export function EnterVrButton() {
  ...
  return (
    <button
      ...
      className="pointer-events-auto flex items-center gap-2 rounded-md bg-indigo-700/90 px-3 py-2 text-xs font-medium text-indigo-50 shadow-lg ring-1 ring-indigo-500 hover:bg-indigo-600"
